...
const ContactForm = () => {
    ...
    const {form,errors,loading,response,handleChange,handleBlur,handleSubmmit} = useForm(initialForm,validationsForm);
  return (
    <div>
        <h2>Formulario de contacto</h2>
        <form onSubmit={handleSubmmit}>
                <input type="text" name="name" placeholder="Escribe tu nobre" onBlur={handleBlur} onChange={handleChange} value={form.name} required />
